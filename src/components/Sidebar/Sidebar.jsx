...
const Sidebar = ({page, setPage}) => {
    return (
        <aside className="sidebar">
            ...
            <nav className="nav">
                <button onClick={() => setPage('board')}className={`nav-link${page === "board" ? " activite" : ""}`} data-page="board">
                ...
                <button onClick={() => setPage('people')} className={`nav-link${page === "people" ?  " activite" : ""}`} data-page="people">
                    <span className="nav-icon">
                        <svg
                            viewBox="0 0 24 24"
                            fill="none"
                ...
                <button onClick={() => setPage('activity')} className={`nav-link${page === "activity" ? " activite" : ""}`} data-page="activity">
                    <span className="nav-icon">
                        <svg
                            viewBox="0 0 24 24"
                            fill="none"
                ...
                <button onClick={() => setPage('settings')} className={`nav-link${page === "settings" ? " activite" : ""}`} data-page="settings">
                    <span className="nav-icon">
                        <svg
                            viewBox="0 0 24 24"
                            fill="none"
